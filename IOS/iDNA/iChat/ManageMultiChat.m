    ...
    if (alertView.tag == 1) {
        ...
        switch (buttonIndex) {
            ...
            case 1:{
                ...
                NSString *child = [NSString stringWithFormat:@"%@%@/multi_chat/%@/", [[Configs sharedInstance] FIREBASE_DEFAULT_PATH],[[Configs sharedInstance] getUIDU], [self.friend objectForKey:@"multi_chat_id"]];
