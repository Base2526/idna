...
//@implementation CreateMyCardThread
//
//@end
...
-(void)start:(NSString *)name: (UIImage*)photo: (NSMutableArray *)email :(NSMutableArray *)phone
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@.json",  [Configs sharedInstance].API_URL, [Configs sharedInstance].CREATE_MY_CARD ]];
    ...
    [dataToSend appendFormat:@"uid=%@&name=%@&photo=%@&", [[Configs sharedInstance] getUIDU], name, imgString];
