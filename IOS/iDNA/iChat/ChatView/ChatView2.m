...
-(void)detectOnline:(NSNotification *) notification{
    ...
    NSMutableDictionary *ff = [[Configs sharedInstance] loadData:[friend objectForKey:@"friend_id"]];//[[(AppDelegate *)[[UIApplication sharedApplication] delegate] friendsProfile] objectForKey:[friend objectForKey:@"friend_id"]];
