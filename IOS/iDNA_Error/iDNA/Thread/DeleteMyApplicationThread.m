...
@implementation DeleteMyApplicationThread
...
-(void)start: (NSString *)item_id
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@.json",  [Configs sharedInstance].API_URL, [Configs sharedInstance].DELETE_MY_APPLICATION ]];
    ...
    [dataToSend appendFormat:@"uid=%@&item_id=%@", [[Configs sharedInstance] getUIDU], item_id];
