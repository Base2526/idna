...
-(void)start: (UIImage *)img: (UIImage *)imgBG :(NSString *)strName: (NSString *)strPhoneNumber :(NSString *) strLocation :(NSString *)strGooglePlus :(NSString *)strFacebook
{
    ...
    NSString *dataToSend = [[NSString alloc] initWithFormat:@"uid=%@&image=%@&imageBG=%@&name=%@&phone_number=%@&location=%@&google_plus=%@&facebook=%@", [[Configs sharedInstance] getUIDU],imgString, imgStringBG, strName, strPhoneNumber, strLocation, strGooglePlus, strFacebook];
