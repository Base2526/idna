...
@implementation HideFriendThread
...
-(void)start: (NSString *)uid_friend: (NSString *)status
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@.json",  [Configs sharedInstance].API_URL, [Configs sharedInstance].HIDE_FRIEND]];
