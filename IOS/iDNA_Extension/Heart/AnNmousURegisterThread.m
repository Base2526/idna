...
@implementation AnNmousURegisterThread
-(void)start: (NSString*) email
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@.json",  [Configs sharedInstance].API_URL, [Configs sharedInstance].ANNMOUSU_REGISTER]];
    ...
    NSString *dataToSend = [[NSString alloc] initWithFormat:@"UDID=%@&email=%@", [[Configs sharedInstance] getUniqueDeviceIdentifierAsString], email];
