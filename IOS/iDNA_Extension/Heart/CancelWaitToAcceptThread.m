...
//@implementation CancelWaitToAcceptThread
//
//@end
...
-(void)start: (NSString *)uid_friend: (NSString *)status
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@.json",  [Configs sharedInstance].API_URL, [Configs sharedInstance].CANCEL_WAIT_TO_ACCEPT]];
