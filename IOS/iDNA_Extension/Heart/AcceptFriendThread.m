...
//@implementation AcceptFriendThread
//
//@end
...
-(void)start: (NSString *)uid_friend
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@.json",  [Configs sharedInstance].API_URL, [Configs sharedInstance].ACCEPT_FRIEND ]];
