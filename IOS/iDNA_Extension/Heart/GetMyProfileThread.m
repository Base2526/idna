...
@implementation GetMyProfileThread
...
-(void)start
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@",  [Configs sharedInstance].API_URL, [Configs sharedInstance].FETCH_MY_PROFILE ]];
