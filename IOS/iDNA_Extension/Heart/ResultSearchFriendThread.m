...
//@implementation ResultSearchFriendThread
//
//@end
...
-(void)start: (NSString *)uid: (NSString *)isQR
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@.json",  [Configs sharedInstance].API_URL, [Configs sharedInstance].RESULT_SEARCH_FRIEND ]];
    ...
    NSString *dataToSend = [[NSString alloc] initWithFormat:@"uid=%@&uid_friend=%@&isQR=%@", [[Configs sharedInstance] getUIDU], uid, isQR];
