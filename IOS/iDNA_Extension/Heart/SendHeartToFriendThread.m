...
//@implementation SendHeartToFriendThread
//
//@end
...
-(void)start: (NSString *)uid_friend
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@.json",  [Configs sharedInstance].API_URL, [Configs sharedInstance].SEND_HEART_TO_FRINEDS ]];
    ...
    NSString *dataToSend = [[NSString alloc] initWithFormat:@"uid=%@&uid_friend=%@", [[Configs sharedInstance] getUIDU], uid_friend];
