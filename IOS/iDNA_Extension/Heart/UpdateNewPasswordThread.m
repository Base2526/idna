...
//@implementation UpdateNewPasswordThread
//
//@end
...
@implementation UpdateNewPasswordThread
-(void)start: (NSString*) old_password: (NSString *) new_password
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@.json",  [Configs sharedInstance].API_URL, [Configs sharedInstance].UPDATE_NEW_PASSWORD]];
    ...
    NSString *dataToSend = [[NSString alloc] initWithFormat:@"uid=%@&old_password=%@&new_password=%@", [[Configs sharedInstance] getUIDU], old_password, new_password];
