//
//  SetClassFriendThread.m
//  Heart
//
//  Created by Somkid on 12/31/2559 BE.
//  Copyright © 2559 Klovers.org. All rights reserved.
//

#import "SetClassFriendThread.h"

//@implementation SetClassFriendThread
//
//@end
...
-(void)start: (NSString *)uid_friend: (NSString *)status
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@.json",  [Configs sharedInstance].API_URL, [Configs sharedInstance].SET_CLASS_FRIEND]];
