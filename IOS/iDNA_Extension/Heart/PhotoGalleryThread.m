...
//@implementation PhotoGalleryThread
//
//@end
...
-(void)start:(NSString *)nid
{
    ...
    NSURL *url = @"";//[NSURL URLWithString:[NSString stringWithFormat:@"%@%@.json",  [Configs sharedInstance].API_URL, [Configs sharedInstance].PHOTO_GALLERY ]];
    ...
    NSString *dataToSend = [[NSString alloc] initWithFormat:@"identifierForVendor=%@&deviceInfo_name=%@&deviceInfo_model=%@&deviceInfo_localizedModel=%@&deviceInfo_systemName=%@&deviceInfo_systemVersion=%@&nid=%@", deviceInfo.identifierForVendor.UUIDString ,deviceInfo.name, deviceInfo.model, deviceInfo.localizedModel, deviceInfo.systemName, deviceInfo.systemVersion, nid];
