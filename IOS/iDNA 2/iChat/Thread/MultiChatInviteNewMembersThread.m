//
//  MultiChatInviteNewMembersThread.m
//  iChat
//
//  Created by Somkid on 7/10/2560 BE.
//  Copyright © 2560 klovers.org. All rights reserved.
//

#import "MultiChatInviteNewMembersThread.h"

//@implementation MultiChatInviteNewMembersThread
//
//@end
...
-(void)start :(NSString *)group_id :(NSArray *)members
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@.json",  [Configs sharedInstance].API_URL, [Configs sharedInstance].MUTI_CHAT_INVITE_NEW_MEMBERS]];
